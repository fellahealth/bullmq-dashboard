...
export type QueueRegistry = Map<string, BaseAdapter>;
...
export interface AppControllerRoute {
  ...
  handler(request?: DashboardRequest): Promisify<ControllerHandlerReturnType>;
}
...
export interface IServerAdapter {
  setQueues(queueRegistry: QueueRegistry): IServerAdapter;
